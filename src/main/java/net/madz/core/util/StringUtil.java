...
public class StringUtil {
	...
	CharsetEncoder encoder = charset == UTF8 ? UTF8_ENCODER : charset
		.newEncoder();
	...
	return toString(c, delimiter, null, null,
	...
	return toString(c, delimiter, before, after,
		ToStringFormatter.getInstance());
    }

    public static <E> String toString(Collection<E> c, String delimiter,
	    String before, String after, Formatter<? super E> formatter) {
	if (c == null) {
	    return null;
	}
    ...
    public static <E> void append(StringBuilder sb, Collection<E> c,
	    String delimiter) {
	append(sb, c, delimiter, null, null, ToStringFormatter.getInstance());
    }

    public static <E> void append(StringBuilder sb, Collection<E> c,
	    String delimiter, Formatter<E> formatter) {
	append(sb, c, delimiter, null, null, formatter);
    }

    public static <E> void append(StringBuilder sb, Collection<E> c,
	    String delimiter, String before, String after) {
	...
	return toString(m, delimiter, "=", true, null, null,
		ToStringFormatter.getInstance(),
		ToStringFormatter.getInstance());
    }

    public static <K, V> String toString(Map<K, V> m, String delimiter,
	    String entryDelimiter, boolean includeEntryDelimiterOnEmptyValue) {
	return toString(m, delimiter, entryDelimiter,
		includeEntryDelimiterOnEmptyValue, null, null,
		ToStringFormatter.getInstance(),
		ToStringFormatter.getInstance());
    }
    ...
    public static <K, V> String toString(Map<K, V> m, String delimiter,
	    ...
	    String before, String after) {
	return toString(m, delimiter, entryDelimiter,
		includeEntryDelimiterOnEmptyValue, before, after,
		ToStringFormatter.getInstance(),
		ToStringFormatter.getInstance());
    }
    ...
    public static <K, V> String toString(Map<K, V> m, String delimiter,
	    String entryDelimiter, boolean includeEntryDelimiterOnEmptyValue,
	    String before, String after, Formatter<? super K> keyFormatter,
	...
	StringBuilder sb = new StringBuilder();
	append(sb, m, delimiter, entryDelimiter,
		includeEntryDelimiterOnEmptyValue, before, after, keyFormatter,
		valueFormatter);
	return sb.toString();
    }

    public static <K, V> void append(StringBuilder sb, Map<K, V> m,
	    String delimiter) {
	append(sb, m, delimiter, "=", true, null, null,
		ToStringFormatter.getInstance(),
		ToStringFormatter.getInstance());
    }
    ...
    public static <K, V> void append(StringBuilder sb, Map<K, V> m,
	    String delimiter, String entryDelimiter,
	    boolean includeEntryDelimiterOnEmptyValue, String before,
	    String after) {
	append(sb, m, delimiter, entryDelimiter,
		includeEntryDelimiterOnEmptyValue, before, after,
		ToStringFormatter.getInstance(),
    ...
    public static <K, V> void append(StringBuilder sb, Map<K, V> m,
	    String delimiter, String entryDelimiter,
	    boolean includeEntryDelimiterOnEmptyValue, String before,
	    String after, Formatter<? super K> keyFormatter,
	    Formatter<? super V> valueFormatter) {
	if (m.isEmpty()) {
	    return;
	}
