...
public class TransitionInvocationHandler<R extends IReactiveObject, S extends IState<R, S>, T extends ITransition>
	...
	final StateContext<R, S> context = new StateContext<R, S>(
		reactiveObject, nextState, transitionEnum);
	...
	try {
	    ...
	    Method stateSetter = reactiveObject.getClass().getDeclaredMethod(
		    "setState", new Class[] { nextState.getClass() });
