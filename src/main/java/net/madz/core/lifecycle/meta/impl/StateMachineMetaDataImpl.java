...
public class StateMachineMetaDataImpl<R extends IReactiveObject, S extends IState<R, S>, T extends ITransition>
	...
	dumper.println(toString()).indent().print("allStates=")
		...
		.print("allRunningStates=").dump(getRunningStateMetaData())
		.print("allStoppedStates=").dump(getStoppedStateMetaData())
		.print("allWaitingStates=").dump(getWaitingStateMetaData())
