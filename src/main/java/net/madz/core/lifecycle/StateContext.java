...
public final class StateContext<R extends IReactiveObject, S extends IState>
    ...
    public StateContext(R reactiveObject, S nextState,
	    ITransition ongoingTransition) {
