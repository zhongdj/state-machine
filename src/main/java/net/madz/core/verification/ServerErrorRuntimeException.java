package net.madz.core.verification;
...
public class ServerErrorRuntimeException extends VerificationRuntimeException {
    ...
    public ServerErrorRuntimeException(Throwable cause, MetaData metaData,
	    String errorKey, String defaultErrorMessage, Object... details) {
	super(cause, new VerificationFailureSet().add(cause, metaData,
		errorKey, defaultErrorMessage, details));
    }

    public ServerErrorRuntimeException(Object source, String errorKey,
	    String defaultErrorMessage, Object... details) {
	super(null, new VerificationFailureSet().add(source, errorKey,
